          ...
          <table style="width: 100%">
            <tbody>
              ...
              <tr style="padding-top: 0">
                <td>
                  <h3 class="title">Login to He-Her</h3>
                </td>
              </tr>
              <tr>
                <td>
                  <p class="welcome-message" style="font-weight: 400; line-height: 30px; font-size: 1rem; padding: 0 44px">It looks like you&#39;re trying to change password to your He-Her account. To access your account, please use the one-time password (OTP) below;</p>
                </td>
              </tr>
              <tr>
              ...
              <tr>
                <td>
                  <p class="welcome-message" style="font-weight: 400; line-height: 30px; font-size: 1rem; padding: 0 44px">This code expires in 10 minutes. <br />
                    <br /> If you didn&#39;t initiate this login attempt, please  contact <br /> our support team immediately via&nbsp; email <a href="mailto:support@he-her.com">support@he-her.com</a>
                    <br /> &nbsp;
                  </p>
                </td>
              </tr>
          ...
          <tr>
            <td>
              <p style="
                ...
                <br /> Copyright © HeHer. 2023 All rights reserved.
              </p>
            </td>
          </tr>
